...
const int MATE_VALUE = 10000;           // ��߷�ֵ���������ķ��?
...
/* ElephantEye�ĺܶ�����ж��õ�?"SIDE_TAG()"��������췽���?16���ڷ���Ϊ32��
...
#ifdef JIEQIMODE
  extern const int cnPieceTypes[80];        // ������Ŷ�Ӧ����������?
  extern const int cnSimpleValues[80];      // ���ӵļ򵥷�ֵ
#else
...
struct PositionStruct {
  ...
  #ifdef JIEQIMODE
  uint8_t ucsqPieces[80];   // ÿ�����ӷŵ�λ�ã�0��ʾ����
  #else
  ...
  union {
  #ifdef JIEQIMODE
         uint64_t dwBitPiece;    // 32λ������λ��0��31λ���α�ʾ����?16��47�������Ƿ���������
          uint16_t wBitPiece[4];  // ��ֳ�����?
  #else
           uint32_t dwBitPiece;    // 32λ������λ��0��31λ���α�ʾ����?16��47�������Ƿ���������
  ...
  MoveStruct LastMove(void) const {        // ǰһ���ŷ������ŷ������˾���Ľ���״�?
  ...
  int DrawValue(void) const {              // ����ķ��?
    return (nDistance & 1) == 0 ? -DRAW_VALUE : DRAW_VALUE;
  }
  int RepValue(int vlRep) const {          // �ظ�����ķ��?
